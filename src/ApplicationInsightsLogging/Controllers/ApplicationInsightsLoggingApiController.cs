...
namespace ApplicationInsightsLogging.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "ApplicationInsightsLogging")]
    public class ApplicationInsightsLoggingApiController : ApplicationInsightsLoggingApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public ApplicationInsightsLoggingApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
